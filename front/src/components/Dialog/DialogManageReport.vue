      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div
          ...
          <TransitionChild
            ...
            <DialogPanel
              class="flex h-[450px] w-full max-w-md transform flex-col overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
              <DialogTitle
                as="h3"
              ...
              <div class="mt-2">
                ...
                <Select :list="actions" :selected-value="selectedAction" @update:model-value="updateAction" />
              </div>
...
const { isLoading: isLoadingReject, mutate: rejectReportsMutation } = useMutation(
  (data) => rejectReports(data),
  {
    onSuccess: () => {
